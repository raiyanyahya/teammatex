...
class TestPeopleProfiler:
    ...
    def test_ownership_computation(self):
        from app.services.onboarding.people_profiler import PeopleProfiler, ContributorProfile
